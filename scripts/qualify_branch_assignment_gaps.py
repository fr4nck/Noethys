...
EXPLICIT_SAFE = {
    ...
    ('Utils/UTILS_Sauvegarde.py', 'Sauvegarde', 'fichierDest', 'body_only', '007306291634f74b26fd54829c0e4781488b68ab658793e54ded91fde0dd2e2d'): (
        "fichierDest est créé sous repertoire != None et sa seule lecture ultérieure reste protégée par exactement le même garde"
    ),
    ('Utils/UTILS_Sauvegarde.py', 'Sauvegarde', 'dictAdresse', 'body_only', 'e5cb45ed2a7c63ac0a56bede820de95ec4b29a29b94bad5aad68421961ac36a5'): (
    ...
    ('Utils/UTILS_Sauvegarde.py', 'Sauvegarde', 'err', 'body_only', '2322737d37937c7115afbdd779223aba52b12fe469dffcdbf671c4c7fc88afab'): (
