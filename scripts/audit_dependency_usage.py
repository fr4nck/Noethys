...
# Correspondance nom PyPI -> module importé.
DIST_TO_MODULE = {
    "pillow": "PIL",
...
def main() -> int:
    ...
    local_modules = {p.stem for p in SOURCE.glob("*.py")}
    local_modules.update(p.name for p in SOURCE.iterdir() if p.is_dir())
    ...
    declared = requirement_modules(REQUIREMENTS)
