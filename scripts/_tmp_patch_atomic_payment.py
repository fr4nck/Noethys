...
start = s.index('    def Sauvegarde(self, IDreglement=None, DBtemp=None):')
end = s.index('\n\n# -----------------------------------------------------------------------------------------------------------------------', start)
...
if s.count('(\"reglement_frais\", self.IDreglement),') != 1:
    raise SystemExit('frais lien inattendu')
