...
class CTRL(wx.Panel):
    """Options d'édition des demandes de location, pilotées par Repens."""
    ...
    def __set_properties(self):
        ...
        self.checkbox_repertoire.SetToolTip(wx.ToolTip(_(u"Enregistrer un exemplaire de chaque document au format PDF dans le répertoire indiqué")))
