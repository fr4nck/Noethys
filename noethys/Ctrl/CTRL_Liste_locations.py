...
class CTRL(wx.Panel):
    ...
    def __init__(self, parent, filtres=[]):
        ...
        self.bouton_apercu = self._CreerBouton(
            _(u"Aperçu location"),
            _(u"Afficher un aperçu de la location sélectionnée"),
        )
        self.bouton_email = self._CreerBouton(
            _(u"Envoyer"),
            _(u"Envoyer la location sélectionnée par Email"),
            icone="mail",
        )
        self.bouton_supprimer = self._CreerBouton(
            _(u"Supprimer"),
            _(u"Supprimer la location sélectionnée ou les locations cochées"),
            icone="delete",
            variante="danger",
        )
