...
class CTRL(wx.Panel):
    """Liste des rappels avec commandes visibles et sélection explicite."""
    ...
    def __init__(self, parent, filtres=[], IDcompte_payeur=None, codesColonnes=["IDrappel", "date_edition", "date_reference", "numero", "famille", "date_min", "date_max", "retard", "email", "solde", "nom_lot", "labelTexte"], checkColonne=True, triColonne="numero"):
        ...
        self.listviewAvecFooter = OL_Rappels.ListviewAvecFooter(
            self,
            kwargs={
        ...
        self.bouton_apercu = self._CreerBouton(_(u"Aperçu rappel"), "Images/16x16/Apercu.png", _(u"Afficher un aperçu de la lettre de rappel sélectionnée"))
        self.bouton_email = self._CreerBouton(_(u"Envoyer"), "Images/16x16/Emails_exp.png", _(u"Envoyer la lettre de rappel sélectionnée par Email"))
        self.bouton_supprimer = self._CreerBouton(_(u"Supprimer"), "Images/16x16/Supprimer.png", _(u"Supprimer la lettre de rappel sélectionnée ou les rappels cochés"))
