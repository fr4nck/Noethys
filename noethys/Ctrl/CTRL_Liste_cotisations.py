...
class CTRL(wx.Panel):
    ...
    def __init__(self, parent, filtres=[], codesColonnes=["IDcotisation", "date_debut", "date_fin", "beneficiaires", "rue", "cp", "ville", "nom", "type_cotisation", "unite_cotisation", "numero", "montant", "solde", "date_creation_carte", "depot_nom", "activites", "observations"], checkColonne=True, triColonne="date_debut"):
        ...
        self.bouton_apercu = self._CreerBouton(
            _(u"Aperçu cotisation"),
            _(u"Afficher un aperçu de la cotisation sélectionnée"),
        )
        self.bouton_email = self._CreerBouton(
            _(u"Envoyer"),
            _(u"Envoyer la cotisation sélectionnée par Email"),
            icone="mail",
        )
        self.bouton_supprimer = self._CreerBouton(
            _(u"Supprimer"),
            _(u"Supprimer la cotisation sélectionnée ou les cotisations cochées"),
            icone="delete",
            variante="danger",
        )
        ...
        self.bouton_configuration = self._CreerBouton(
            _(u"Configurer"),
            _(u"Configurer les colonnes et l'affichage de la liste"),
            variante="ghost",
        )
