...
class CTRL(HTL.HyperTreeList):
    def __init__(self, parent, listeIDconso=[]):
        ...
        for label, largeur, alignement in listeColonnes:
            ...
            self.SetColumnWidth(numColonne, Style.px(largeur))
    ...
    def Importation(self):
        ...
        if len(self.listeIDconso) == 0:
            conditionConso = "()"
        elif len(self.listeIDconso) == 1:
            conditionConso = "(%d)" % self.listeIDconso[0]
        else:
            conditionConso = str(tuple(self.listeIDconso))
    ...
    def Remplissage(self):
        ...
        for date in listeDates:
            ...
            self.SetItemBackgroundColour(niveauDate, Style.couleur("surface_container"))
            self.SetItemTextColour(niveauDate, Style.couleur("on_surface"))
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.SetSize((Style.px(900), Style.px(500)))
        self.Layout()
        self.CenterOnScreen()
