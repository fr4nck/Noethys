...
class CTRL(wx.Panel):
    """Options d'édition des inscriptions, sans géométrie locale historique."""
    ...
    def __set_properties(self):
        ...
        self.checkbox_repertoire.SetToolTip(wx.ToolTip(_(u"Enregistrer un exemplaire de chaque inscription au format PDF dans le répertoire indiqué")))
