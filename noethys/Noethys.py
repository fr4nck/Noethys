    ...
    def CreationBarreMenus(self):
        ...
        self.listeItemsMenu = [
            ...
            {"code" : "menu_individus", "label" : _(u"Individus"), "items" : [
                    ...
                    {"code" : "liste_pieces_manquantes", "label" : _(u"Liste des pièces manquantes"), "infobulle" : _(u"Editer la liste des pièces manquantes"), "image" : "Images/16x16/Piece.png", "action" : self.On_individus_pieces_manquantes},
