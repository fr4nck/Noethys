...
DB_STRUCTURES = {
    ...
    "structures_relations": [
        ("IDrelation_structure", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID local de la relation contractuelle"),
        ("uid", "VARCHAR(64)", u"Identifiant stable inter-applications de la relation"),
        ("IDstructure", "INTEGER", u"Structure bénéficiaire"),
        ...
        ("libelle", "VARCHAR(300)", u"Libellé métier de la relation ou prestation"),
        ("saison", "VARCHAR(50)", u"Saison ou exercice de référence optionnel"),
        ...
        ("nom_intervenant", "VARCHAR(200)", u"Nom d'affichage historique de l'intervenant"),
        ("date_debut", "DATE", u"Début de la relation"),
        ("date_fin", "DATE", u"Fin de la relation"),
        ("tarif", "FLOAT", u"Tarif de référence"),
        ("unite_tarif", "VARCHAR(50)", u"heure, seance, forfait, journee, autre"),
        ("regle_adhesion", "VARCHAR(50)", u"requise, non_requise, non_applicable, exoneree"),
        ...
        ("memo", "VARCHAR(2000)", u"Mémo"),
        ("date_creation", "DATE", u"Date de création de la relation"),
        ("date_modification", "DATE", u"Date de dernière modification de la relation"),
    ],

    "structures_payeurs": [
        ("IDpayeur_structure", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID local de la prise en charge"),
        ...
        ("taux_prise_en_charge", "FLOAT", u"Taux de prise en charge optionnel, de 0 à 100"),
        ...
        ("actif", "INTEGER", u"Prise en charge active 0/1"),
        ("date_creation", "DATE", u"Date de création de la prise en charge"),
        ("date_modification", "DATE", u"Date de dernière modification de la prise en charge"),
    ],
}
