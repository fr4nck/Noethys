...
DB_STRUCTURES = {
    ...
    "lieux": [
        ...
        ("rue", "VARCHAR(255)", u"Adresse du lieu"),
        ...
        ("IDstructure_gestionnaire", "INTEGER", u"Structure propriétaire ou gestionnaire optionnelle"),
        ("informations_acces", "VARCHAR(2000)", u"Accès, clés, réservation et consignes pratiques"),
        ("notes", "VARCHAR(2000)", u"Notes libres"),
    ...
    "interventions_execution": [
        ("IDexecution_intervention", "INTEGER PRIMARY KEY AUTOINCREMENT", u"ID local de l'exécution"),
        ("IDintervention", "INTEGER", u"Séance canonique concernée"),
        ("UIDintervenant_habituel", "VARCHAR(100)", u"Identifiant RH stable de l'intervenant habituel"),
        ("UIDintervenant_prevu", "VARCHAR(100)", u"Identifiant RH stable de l'intervenant prévu"),
        ("UIDintervenant_reel", "VARCHAR(100)", u"Identifiant RH stable de l'intervenant réellement présent"),
        ("IDlieu_prevu", "INTEGER", u"Lieu prévu optionnel"),
        ("IDlieu_reel", "INTEGER", u"Lieu réellement utilisé optionnel"),
        ...
        ("duree_reelle_minutes", "INTEGER", u"Durée réelle calculée en minutes"),
        ("commentaire_realise", "VARCHAR(2000)", u"Commentaire métier de validation terrain"),
        ("date_modification", "DATE", u"Date de dernière modification"),
    ],
