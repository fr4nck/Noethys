...
class CategorieConventionTests(unittest.TestCase):
    ...
    def test_classe_convention_expose_les_champs_attendus(self):
        ...
        for attendu in (
            ...
            "{CONVENTION_REFERENT_FACTURATION_NOM_COMPLET}",
            "{CONVENTION_REFERENT_FACTURATION_FONCTION}",
            "{CONVENTION_REFERENT_FACTURATION_EMAIL}",
            "{CONVENTION_REFERENT_FACTURATION_TELEPHONE}",
            "{CONVENTION_SAISON}",
